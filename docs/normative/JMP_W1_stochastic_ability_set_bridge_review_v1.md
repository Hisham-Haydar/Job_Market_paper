...
| **Unresolved decisions** | The §12.7 decision, now with branch (iii). Evidence-row-25 conventions plus the availability declaration and the finite-$\mathcal J$ extension. F35 coefficient status in the S11 spec (three sources disagree). Sex flags of 1504300 and 1550400. Wage draw-support reconciliation. |
