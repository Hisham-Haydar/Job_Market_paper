...
\subsection{The distinct ex-ante opportunity-prospect metric}\label{the-distinct-ex-ante-opportunity-prospect-metric}
...
\subsection{Preliminary restricted structural decomposition}\label{preliminary-restricted-structural-decomposition}
...
\textbf{Four-group corrected diagnostic adjudication.} On the weighted composite rule, the conditioning verdict is MECHANICAL\_STOCHASTIC\_CONDITIONING in all four groups. The excess-dispersion verdict is MISSPECIFICATION\_EVIDENCE for coupled men and coupled women, and INCONCLUSIVE\_QUADRATURE\_LIMITED for single men and single women. Numerical adequacy of one displayed accuracy and the composite verdict are different gates. The earlier three-group excess-predictability claim is withdrawn; the corrected evidence is reported only through these four group-specific adjudications.
...
\bibliography{JMP_working_paper_for_seminar_v7}
...
% Predictive diagnostics: POSFIT v3b; repository MNL_posfit; branch diagnostics/posfit-v3; commit cd7247cf; artifact outputs/positive_fit_diagnostics_v3b/run_provenance.json; SHA-256 34A4EC87ED1C4218984961BB3493062B4281DB2C42437B47DA01A78973380E58.
...
% REPORT-V7: corrected POSFIT-v3b and Band-Fix-2 fit evidence; DECOMP-2 evidence inherited unchanged after no-dependency verification.
