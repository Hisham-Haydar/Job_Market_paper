...
The current nested resources-and-composition table reports both populations. For couples, the raw Gini identity is \(C_D=0.067827=0.043551+0.024276\); on the equivalized basis it is \(0.072396=0.041364+0.031032\). Singles also have a corrected geography-within-access attribution, reported in the discussion notebook, Section 8, table \emph{Nested geography for singles}; the corresponding budget split is in \emph{Nested resources and composition for both populations}.
