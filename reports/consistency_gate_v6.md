...
Artifacts: `JMP_working_paper_for_seminar_v6.tex`, `JMP_research_story_report_v6.html`, `story_v6.generated.md`, `numbers_of_record_v6.json`.
...
- registry: 127 entries, 59 used by the two documents, every used entry typed and sourced
...
- no retired-lineage path reference found in build_v5.py, v5_sections.py, common.py, numbers_of_record_v6.json (entries/gallery only), JMP_working_paper_for_seminar_v6.tex, or JMP_research_story_report_v6.html

## 18. Retired ex-ante inclusive-value welfare construction: not presented as the measure (MEASURE-MAP-1R / Deputy ruling R2) — PASS

- no undisclaimed ex-ante J/H construction found in JMP_working_paper_for_seminar_v6.tex or JMP_research_story_report_v6.html
