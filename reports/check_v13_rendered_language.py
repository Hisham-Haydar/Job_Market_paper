...
OUT_JSON = ROOT / "reports/v13_banned_term_audit.json"
OUT_MD = ROOT / "reports/v13_banned_term_audit.md"
NEGATIVE_JSON = ROOT / "reports/v13_banned_term_negative_control.json"
NEGATIVE_MD = ROOT / "reports/v13_banned_term_negative_control.md"
...
def main() -> int:
    ...
    for path in (OUT_MD, NEGATIVE_MD):
        text = path.read_text(encoding="utf-8").replace("V8", "V13")
        path.write_text(text, encoding="utf-8", newline="\n")
    payload = json.loads(OUT_JSON.read_text(encoding="utf-8"))
    payload["gate"] = "V13 rendered-text banned-term audit"
