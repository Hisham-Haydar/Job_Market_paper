...
report = (ROOT / "reports/JMP_research_story_report_v12.html").read_text(encoding="utf-8")
gallery = (ROOT / "reports/JMP_results_gallery_v12.html").read_text(encoding="utf-8")
...
if failed:
    raise SystemExit("V12 surface sync failed: " + ", ".join(failed))
