# V11 rendered-text banned-term audit
...
- Begin: `<!-- V11_PROVENANCE_APPENDIX_BEGIN -->`
- End: `<!-- V11_PROVENANCE_APPENDIX_END -->`
...
|---|---:|---:|---:|---:|
| `reports/JMP_research_story_report_v11.html` | 1 | 1 | 0 | **PASS** |
| `reports/JMP_results_gallery_v11.html` | 1 | 1 | 0 | **PASS** |
