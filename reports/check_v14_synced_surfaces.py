...
report = (ROOT / "reports/JMP_research_story_report_v14.html").read_text(encoding="utf-8")
gallery = (ROOT / "reports/JMP_results_gallery_v14.html").read_text(encoding="utf-8")
...
if failed:
    raise SystemExit("V14 surface sync failed: " + ", ".join(failed))
