...
OUT_JSON = ROOT / "reports/v13_stage_a_status_results.json"
...
def main() -> int:
    ...
    payload = {"gate": "V13 Stage A ex-ante status", "status": status,
    ...
    print(f"V13 STAGE A STATUS {status}: report {report['stale_occurrences']} stale / "
