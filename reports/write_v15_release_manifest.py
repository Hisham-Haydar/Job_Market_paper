"""Write the V15 surface manifest (paths, sizes, SHA-256) after the suite passes."""
...
OUT_JSON = ROOT / "reports/v15_surface_manifest.json"
B = "reports/research_story_build/"

SURFACES = {
    "report HTML": ROOT / "reports/JMP_research_story_report_v15.html",
    "reader-facing gallery": ROOT / "reports/JMP_results_gallery_v15.html",
    "editable resolved Markdown": ROOT / (B + "story_v15.generated.md"),
    "editable section source": ROOT / (B + "v15_sections.py"),
    "illustration text source": ROOT / (B + "v11_illustration.py"),
    "numerical input adapter": ROOT / (B + "v15_render_inputs.py"),
    "report builder": ROOT / (B + "build_v15.py"),
    ...
    "V15 numerical registry": ROOT / "reports/numbers_of_record_v15.json",
    ...
    "complete gate summary": ROOT / "reports/v15_release_gate_summary.md",
}


def main() -> None:
    gate = json.loads((ROOT / "reports/v15_release_gate_summary.json").read_text(encoding="utf-8"))
    if gate["status"] != "PASS":
        raise SystemExit("V15 release suite has not passed")
    ...
    payload = {"release": "V15", "status": "PASS",
               "constraints": {"reestimation": False, "repricing": False, "welfare_recomputed": False,
                               ...
                               "v9_overwritten": False, "v10_overwritten": False, "v11_overwritten": False, "v12_overwritten": False, "v13_overwritten": False, "v14_overwritten": False,
