"""V13 gate: no section title appears in both the body and the appendix.
...
OUT_JSON = ROOT / "reports/v13_section_title_results.json"
BEGIN = "<!-- V13_PROVENANCE_APPENDIX_BEGIN -->"
END = "<!-- V13_PROVENANCE_APPENDIX_END -->"
SURFACES = {
    "report": (ROOT / "reports/JMP_research_story_report_v13.html", r"h[1-3]"),
    "gallery": (ROOT / "reports/JMP_results_gallery_v13.html", r"h[23]"),
}
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="jmp-v13-title-control-") as tmp:
    ...
    payload = {"gate": "V13 body/appendix section-title uniqueness", "status": status,
               "surfaces": results,
    ...
    print(f"V13 SECTION TITLES {status}: report shared {results['report']['shared']}, "
