...
*Discussion draft. These decomposition estimates are preliminary and subject to ongoing numerical validation of the counterfactual integration.*
...
2016, whose incomes refer to 2015, and
the French 2015 tax-benefit system. The estimation samples
contain 1,540 single-adult households and
2,223 couples. The two household types are estimated separately.
...
precise to report an accuracy of 85.7% for single
women, against a model-simulated range of
80.0%–85.9%, and
89.8% for coupled women, against
88.1%–91.2%.
...
6.5 for coupled women. This finding concerns the
