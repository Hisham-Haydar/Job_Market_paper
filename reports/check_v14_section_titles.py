"""V14 gate: no section title appears in both the body and the appendix.
...
OUT_JSON = ROOT / "reports/v14_section_title_results.json"
BEGIN = "<!-- V14_PROVENANCE_APPENDIX_BEGIN -->"
END = "<!-- V14_PROVENANCE_APPENDIX_END -->"
SURFACES = {
    "report": (ROOT / "reports/JMP_research_story_report_v14.html", r"h[1-3]"),
    "gallery": (ROOT / "reports/JMP_results_gallery_v14.html", r"h[23]"),
}
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="jmp-v14-title-control-") as tmp:
    ...
    payload = {"gate": "V14 body/appendix section-title uniqueness", "status": status,
               "surfaces": results,
    ...
    print(f"V14 SECTION TITLES {status}: report shared {results['report']['shared']}, "
