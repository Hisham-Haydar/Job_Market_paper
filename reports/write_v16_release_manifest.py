"""Write the V16 surface manifest (paths, sizes, SHA-256) after the suite passes."""
...
OUT_JSON = ROOT / "reports/v16_surface_manifest.json"
B = "reports/research_story_build/"

SURFACES = {
    "report HTML": ROOT / "reports/JMP_research_story_report_v16.html",
    "reader-facing gallery": ROOT / "reports/JMP_results_gallery_v15.html",
    "editable resolved Markdown": ROOT / (B + "story_v16.generated.md"),
    "editable section source": ROOT / (B + "v16_sections.py"),
    "illustration text source": ROOT / (B + "v11_illustration.py"),
    "numerical input adapter": ROOT / (B + "v15_render_inputs.py"),
    "report builder": ROOT / (B + "build_v16.py"),
    "gallery builder": ROOT / "reports/results_gallery_build/build_v15.py",
    ...
    "V16 numerical registry": ROOT / "reports/numbers_of_record_v16.json",
    "theory figure (restored original)": ROOT / "manuscript/figures/v5/theory_w1.png",
    ...
    "complete gate summary": ROOT / "reports/v16_release_gate_summary.md",
}


def main() -> None:
    gate = json.loads((ROOT / "reports/v16_release_gate_summary.json").read_text(encoding="utf-8"))
    if gate["status"] != "PASS":
        raise SystemExit("V16 release suite has not passed")
    ...
    payload = {"release": "V16", "status": "PASS",
               "constraints": {"reestimation": False, "repricing": False, "welfare_recomputed": False,
                               ...
                               "v9_overwritten": False, "v10_overwritten": False, "v11_overwritten": False, "v12_overwritten": False, "v13_overwritten": False, "v14_overwritten": False, "v15_overwritten": False,
