...
OUT_JSON = ROOT / "reports/v14_stage_a_status_results.json"
...
def main() -> int:
    ...
    payload = {"gate": "V14 Stage A ex-ante status", "status": status,
    ...
    print(f"V14 STAGE A STATUS {status}: report {report['stale_occurrences']} stale / "
