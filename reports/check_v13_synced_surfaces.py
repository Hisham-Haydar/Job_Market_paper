"""Check the V12 report and gallery with the V11 deck, rehearsal script and notebook, notebook, deck and rehearsal script are synchronised."""
...
report = (ROOT / "reports/JMP_research_story_report_v13.html").read_text(encoding="utf-8")
gallery = (ROOT / "reports/JMP_results_gallery_v13.html").read_text(encoding="utf-8")
...
if failed:
    raise SystemExit("V13 surface sync failed: " + ", ".join(failed))
