"""Write the V12 surface manifest (paths, sizes, SHA-256) after the suite passes."""
...
OUT_JSON = ROOT / "reports/v12_surface_manifest.json"
B = "reports/research_story_build/"

SURFACES = {
    "report HTML": ROOT / "reports/JMP_research_story_report_v12.html",
    "reader-facing gallery": ROOT / "reports/JMP_results_gallery_v12.html",
    "editable resolved Markdown": ROOT / (B + "story_v12.generated.md"),
    "editable section source": ROOT / (B + "v12_sections.py"),
    "illustration text source": ROOT / (B + "v11_illustration.py"),
    "numerical input adapter": ROOT / (B + "v12_render_inputs.py"),
    "report builder": ROOT / (B + "build_v12.py"),
    "gallery builder": ROOT / "reports/results_gallery_build/build_v12.py",
    ...
    "V12 numerical registry": ROOT / "reports/numbers_of_record_v12.json",
    ...
    "complete gate summary": ROOT / "reports/v12_release_gate_summary.md",
}


def main() -> None:
    gate = json.loads((ROOT / "reports/v12_release_gate_summary.json").read_text(encoding="utf-8"))
    if gate["status"] != "PASS":
        raise SystemExit("V12 release suite has not passed")
    ...
    payload = {"release": "V12", "status": "PASS",
               "constraints": {"reestimation": False, "repricing": False, "welfare_recomputed": False,
                               ...
                               "v9_overwritten": False, "v10_overwritten": False, "v11_overwritten": False,
