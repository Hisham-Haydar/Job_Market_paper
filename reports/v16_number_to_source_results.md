...
| every V15 registry value unchanged in V16 | `numbers_of_record_v15.json vs v16 (no differences)` | **PASS** |
| V14 adds no registry key | `` | **PASS** |
| every scalar placeholder resolves | `V16 registry` | **PASS** |
...
- V15 predecessor registry: `c456e6ecb554bb31c0791824cd4734533274d83fa3f282789cf8caca09c79909` — `Job_Market_paper/reports/numbers_of_record_v15.json`
