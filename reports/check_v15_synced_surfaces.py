...
report = (ROOT / "reports/JMP_research_story_report_v15.html").read_text(encoding="utf-8")
gallery = (ROOT / "reports/JMP_results_gallery_v15.html").read_text(encoding="utf-8")
...
if failed:
    raise SystemExit("V15 surface sync failed: " + ", ".join(failed))
