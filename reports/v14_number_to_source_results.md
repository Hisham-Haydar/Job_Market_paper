...
| every V13 registry value unchanged in V14 | `numbers_of_record_v13.json vs v14 (no differences)` | **PASS** |
| V14 adds no registry key | `` | **PASS** |
| every scalar placeholder resolves | `V14 registry` | **PASS** |
...
| theory figure carries no estimated or certified number | `caption digits 2026, 3; generator draws no numeric ticks` | **PASS** |
| theory figure regenerated, palette-encoded, not the old stored image | `fig_v14_theory_own_set.png` | **PASS** |
| research_story_report: every other figure byte-identical to V13 | `16 V13 images, 17 V14 images` | **PASS** |
| results_gallery: every other figure byte-identical to V13 | `21 V13 images, 22 V14 images` | **PASS** |
...
- V13 predecessor registry: `12d4db38c75dd448348a764bdba4ed913ab9a86a0e4bfa63c63f22444eabfe71` — `Job_Market_paper/reports/numbers_of_record_v13.json`
