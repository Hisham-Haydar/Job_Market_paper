...
OUT_JSON = ROOT / "reports/v12_stage_a_status_results.json"
...
def main() -> int:
    ...
    payload = {"gate": "V12 Stage A ex-ante status", "status": status,
    ...
    print(f"V12 STAGE A STATUS {status}: report {report['stale_occurrences']} stale / "
