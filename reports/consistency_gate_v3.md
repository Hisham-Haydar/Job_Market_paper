...
Run over a freshly rebuilt H, a freshly re-executed N (15 code cells, execution counts 1-15, zero error outputs), and the deck content the three rebuilt PDFs were compiled from. Registry regenerated by `beamer/make_numbers_of_record_v1.py` at 415 entries.
