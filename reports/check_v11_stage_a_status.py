"""Stage A status gate for V11, with a negative control that must fire.
...
OUT_JSON = ROOT / "reports/v11_stage_a_status_results.json"
...
def main() -> int:
    ...
    payload = {"gate": "V11 Stage A ex-ante status", "status": status,
    ...
    print(f"V11 STAGE A STATUS {status}: report {report['stale_occurrences']} stale / "
