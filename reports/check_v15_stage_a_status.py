...
OUT_JSON = ROOT / "reports/v15_stage_a_status_results.json"
...
def main() -> int:
    ...
    payload = {"gate": "V15 Stage A ex-ante status", "status": status,
    ...
    print(f"V15 STAGE A STATUS {status}: report {report['stale_occurrences']} stale / "
