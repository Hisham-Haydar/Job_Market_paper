"""Build the V11 rehearsal script from the compiled R11 deck."""
...
source = (ROOT / "beamer/JMP_seminar_deck_r11.tex").read_text(encoding="utf-8")
numbers = (ROOT / "beamer/deck_numbers_r11.tex").read_text(encoding="utf-8")
...
document = pymupdf.open(ROOT / "beamer/build/JMP_seminar_deck_r11.pdf")
...
payload = "\n".join(out)
target = ROOT / "reports/rehearsal_pack_v11.md"
